...
def chooseAndSayWord(upperBound,word,correctWords,incorrectWords):
  if not word:
    word = chooseWord(upperBound)
  output = showDialog(word)
  if "Repeat" in output:
     sayWord("Repeating the word")
     chooseAndSayWord(upperBound,word,correctWords,incorrectWords)
  if "Show" in output:
...
if __name__=="__main__":
   ...
   for i in xrange(totalWordsToChoose):
     chooseAndSayWord(250,"",correctWords,incorrectWords)
